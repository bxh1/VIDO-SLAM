...
protected:
    ...
    void UpdateFrameIMU(const float s, const IMU::Bias &b, Frame* pCurrentFrame);
    //ORB
    ...
    std::vector<IMU::Point> mvImuFrompLastFrame;
    std::mutex mMutexImuQueue;
    
     // Imu preintegration from last frame
    IMU::Preintegrated *mpImuPreintegratedFrompLastFrame;

    // Imu calibration parameters
    IMU::Calib *mpImuCalib;

    // Last Bias Estimation 
    IMU::Bias mLastBias;
