/**
* This file is part of VIDO-SLAM.
*
* Copyright (C) 2021-2022 xinhui bai 
* For more information see <https://github.com/bxh1/VIDO_SLAM>
*
**/
...
public:
    ...
    // Constructor for RGBD-IMU.
    Frame(const bool &bImu, Frame *preFrame, const cv::Mat &imGray, const cv::Mat &imDepth, const cv::Mat &imFlow, const cv::Mat &maskSEM, const IMU::Calib &ImuCalib, const double &timeStamp, ORBextractor* extractor,
          cv::Mat &K, cv::Mat &distCoef, const float &bf, const float &thDepth, const float &thDepthObj, const int &UseSampleFea);
...
public:
    ...
    IMU::Calib mImuCalib;
     ...
     // Imu preintegration from lastframe
